    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
           // 'script_url' => $this->get_full_url().'/',
            'script_url' => 'http://localhost/ff2014/wp-content/plugins/avatar-fiesta',
       //     'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            'upload_dir' => 'C:/xampp/htdocs/ff2014/wp-content/uploads/temporales/',
            //'upload_url' => $this->get_full_url().'/files/',
            'upload_url' => 'http://localhost/ff2014/wp-content/uploads/temporale/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
